...
//        System.out.println("driver:"+dbConfig.driver);
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/jwms?useUnicode=true&characterEncoding=UTF-8");
        dataSource.setUsername("root");
        dataSource.setPassword("Wx210819");
...
//        dataSource.setMaxWait(maxWait);
    ...
    public MapperScannerConfigurer mapperScannerConfigurer() {
        ...
        mapperScannerConfigurer.setBasePackage("com.geekerstar.dao");
